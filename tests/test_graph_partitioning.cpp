...
void test_spmv_data_formatter_no_pad_marker() {
    ...
    const uint32_t out_buffer_len = 7;
    ...
    formatter.format(out_buffer_len, vector_buffer_len, num_hbm_channels);
    ...
    auto partition_1_channel_1_data = formatter.get_packed_data(0, 0, 0);
    auto partition_1_channel_1_indices = formatter.get_packed_indices(0, 0, 0);
    auto partition_1_channel_1_indptr = formatter.get_packed_indptr(0, 0, 0);
    auto partition_1_channel_2_data = formatter.get_packed_data(0, 0, 1);
    auto partition_1_channel_2_indices = formatter.get_packed_indices(0, 0, 1);
    auto partition_1_channel_2_indptr = formatter.get_packed_indptr(0, 0, 1);
    auto partition_2_channel_1_data = formatter.get_packed_data(0, 1, 0);
    auto partition_2_channel_1_indices = formatter.get_packed_indices(0, 1, 0);
    auto partition_2_channel_1_indptr = formatter.get_packed_indptr(0, 1, 0);
    auto partition_2_channel_2_data = formatter.get_packed_data(0, 1, 1);
    auto partition_2_channel_2_indices = formatter.get_packed_indices(0, 1, 1);
    auto partition_2_channel_2_indptr = formatter.get_packed_indptr(0, 1, 1);
...
void test_spmv_data_formatter_pad_marker() {
    ...
    SpMVDataFormatter<float, num_PEs_per_hbm_channel, packed_data_type, packed_index_type>
        formatter(num_rows, num_cols, adj_data, adj_indices, adj_indptr);
    formatter.format_pad_marker_end_of_row(out_buffer_len, vector_buffer_len,
                                           num_hbm_channels, val_marker, idx_marker);

    std::vector<packed_data_type> reference_data_row_partition_1_channel_1 =
        {{1,5}, {2,6}, {3,val_marker}, {4,0}, {val_marker,0}};
    std::vector<packed_index_type> reference_indices_row_partition_1_channel_1 =
        {{0,0}, {1,2}, {2,idx_marker}, {3,0}, {idx_marker,0}};
    std::vector<packed_data_type> reference_data_row_partition_1_channel_2 = {{7,8}, {val_marker,val_marker}};
    std::vector<packed_index_type> reference_indices_row_partition_1_channel_2 = {{1,3}, {idx_marker,idx_marker}};

    std::vector<packed_data_type> reference_data_row_partition_2_channel_1 = {{9,val_marker}, {val_marker,0}};
    std::vector<packed_index_type> reference_indices_row_partition_2_channel_1 = {{2,idx_marker}, {idx_marker,0}};
    std::vector<packed_data_type> reference_data_row_partition_2_channel_2 = {{val_marker,val_marker}};
    std::vector<packed_index_type> reference_indices_row_partition_2_channel_2 = {{idx_marker,idx_marker}};

    auto data_row_partition_1_channel_1 = formatter.get_packed_data(0, 0, 0);
    auto indices_row_partition_1_channel_1 = formatter.get_packed_indices(0, 0, 0);
    auto data_row_partition_1_channel_2 = formatter.get_packed_data(0, 0, 1);
    auto indices_row_partition_1_channel_2 = formatter.get_packed_indices(0, 0, 1);

    auto data_row_partition_2_channel_1 = formatter.get_packed_data(1, 0, 0);
    auto indices_row_partition_2_channel_1 = formatter.get_packed_indices(1, 0, 0);
    auto data_row_partition_2_channel_2 = formatter.get_packed_data(1, 0, 1);
    auto indices_row_partition_2_channel_2 = formatter.get_packed_indices(1, 0, 1);

    check_packed_vector_equal<packed_data_type, num_PEs_per_hbm_channel>(
        data_row_partition_1_channel_1, reference_data_row_partition_1_channel_1);
    check_packed_vector_equal<packed_index_type, num_PEs_per_hbm_channel>(
        indices_row_partition_1_channel_1, reference_indices_row_partition_1_channel_1);
    check_packed_vector_equal<packed_data_type, num_PEs_per_hbm_channel>(
        data_row_partition_1_channel_2, reference_data_row_partition_1_channel_2);
    check_packed_vector_equal<packed_index_type, num_PEs_per_hbm_channel>(
        indices_row_partition_1_channel_2, reference_indices_row_partition_1_channel_2);
    check_packed_vector_equal<packed_data_type, num_PEs_per_hbm_channel>(
        data_row_partition_2_channel_1, reference_data_row_partition_2_channel_1);
    check_packed_vector_equal<packed_index_type, num_PEs_per_hbm_channel>(
        indices_row_partition_2_channel_1, reference_indices_row_partition_2_channel_1);
    check_packed_vector_equal<packed_data_type, num_PEs_per_hbm_channel>(
        data_row_partition_2_channel_2, reference_data_row_partition_2_channel_2);
    check_packed_vector_equal<packed_index_type, num_PEs_per_hbm_channel>(
        indices_row_partition_2_channel_2, reference_indices_row_partition_2_channel_2);
