...
void OverlaySynthesizer::generate_kernel_ini() {
    ...
    ini << "sp=overlay_1.spmv_vector:DDR[0]" << std::endl;
    ini << "sp=overlay_1.spmv_mask:DDR[0]" << std::endl;
    ini << "sp=overlay_1.spmv_out:DDR[0]" << std::endl;
    // SpMSpV
    ini << "sp=overlay_1.spmspv_matrix:DDR[1]" << std::endl;
    ini << "sp=overlay_1.spmspv_matrix_indptr:DDR[1]" << std::endl;
    ini << "sp=overlay_1.spmspv_matrix_partptr:DDR[1]" << std::endl;
    ini << "sp=overlay_1.spmspv_vector:DDR[0]" << std::endl;
    ini << "sp=overlay_1.spmspv_mask:DDR[0]" << std::endl;
    ini << "sp=overlay_1.spmspv_out:DDR[0]" << std::endl;
    // enable retiming
    ini << "[vivado]" << std::endl;
